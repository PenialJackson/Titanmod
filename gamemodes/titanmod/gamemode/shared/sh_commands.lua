...
function ImportHUDCode(ply, cmd, args)
	...
	ply:ConCommand("tm_hud_keypressoverlay_x " .. var[48])
	ply:ConCommand("tm_hud_keypressoverlay_y " .. var[49])
	ply:ConCommand("tm_hud_keypressoverlay_inactive_r " .. var[50])
	ply:ConCommand("tm_hud_keypressoverlay_inactive_g " .. var[51])
	ply:ConCommand("tm_hud_keypressoverlay_inactive_b " .. var[52])
	ply:ConCommand("tm_hud_keypressoverlay_actuated_r " .. var[53])
	ply:ConCommand("tm_hud_keypressoverlay_actuated_g " .. var[54])
	ply:ConCommand("tm_hud_keypressoverlay_actuated_b " .. var[55])
	ply:ConCommand("tm_hud_velocitycounter_x " .. var[56])
	ply:ConCommand("tm_hud_velocitycounter_y " .. var[57])
