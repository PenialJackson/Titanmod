...
ATTACHMENT.Name = "Gust"
ATTACHMENT.ShortName = "Gust"
ATTACHMENT.Description = { TFA.AttachmentColors["+"], "Your weapon now knocks you backwards after firing", TFA.AttachmentColors["-"], "-40% Damage", TFA.AttachmentColors["-"], "+120% Spread and ADS Spread"  }
